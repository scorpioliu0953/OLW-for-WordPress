...
// using OpenLiveWriter.BlogClient.Clients; // Removed: no longer referencing specific client types directly
    ...
    internal class PostEditorMainControl : UserControl, IFormClosingHandler, IBlogPostEditor, IBlogPostEditingSite, IUIApplication, ISessionHandler
    {
        ...
        private void InitializeCommands()
        {
            ...
            if (ApplicationDiagnostics.TestMode)
            {
                ...
                _htmlEditor.CommandManager.Add(CommandId.ShowGoogleCaptcha, delegate { /* Removed: Google Blogger no longer supported */ });
        ...
        private void UpdateFrameUI()
        {
            ...
            _mainFrameWindow.Caption = String.Format(CultureInfo.CurrentCulture, Res.Get(StringId.WindowTitleFormat), postDescription, ApplicationEnvironment.ProductNameQualified) + " [v0.7.3]";
