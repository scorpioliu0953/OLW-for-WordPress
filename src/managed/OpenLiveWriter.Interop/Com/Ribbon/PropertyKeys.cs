...
namespace OpenLiveWriter.Interop.Com.Ribbon
{
    public static class PropertyKeys
    {
        ...
        static PropertyKeys()
        {
            ...
            // Global properties (indices from Windows SDK UIRibbon.h / UIRibbonPropertyHelpers.h)
            // Note: SetUICommandProperty for these is broken on Windows 10 1809+ (Microsoft known issue)
