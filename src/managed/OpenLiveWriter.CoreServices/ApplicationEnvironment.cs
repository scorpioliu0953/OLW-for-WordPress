...
namespace OpenLiveWriter.CoreServices
{
    ...
    public class ApplicationEnvironment
    {
        ...
        public static string TaskbarApplicationId = "OLW for WordPress - {3DDDAFC5-5C01-4BCF-B81A-A4976A0999E9}";

        private const string DefaultProductName = "OLW for WordPress";
